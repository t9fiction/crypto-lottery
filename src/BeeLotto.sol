...
contract BeeLotto {
    ...
    function DrawWinnerTicket() public onlyOwner {
        ...
        uint256 randomNumber = uint256(
            keccak256(abi.encodePacked(block.prevrandao, block.timestamp, blockHash))
        );
    ...
    function updateTicketCommission(uint256 _noOfTokensAsCommission) public onlyOwner returns(bool){
        require(_noOfTokensAsCommission * 10**16 < ticketPrice,"Commission can't be greater then the Price of the Ticket");
